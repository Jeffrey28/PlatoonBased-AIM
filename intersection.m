...
lane2To4 = [205 180;%Lane 2 go straight
    ...
    205 245;
    205 380];
lane2To1 = [205 180;%Lane 1 Turn left
    205    190;
    205    195;
    200   200;
    190   205;
...
lane3To4;%Lane 3 turn right
lane3To1;%Lane 3 go straight
lane3To2;%Lane 3 turn left
lane4To1;%Lane 4 turn right
lane4To2;%Lane 4 go straight
lane4To3;
...
function path = getTrajectory(obj,arrivalLane,turn)
      ...
      methods(Static)
          ...
          function map = getMap(varargin)
            ...
            map = robotics.OccupancyGrid(intersectionGridMap);
